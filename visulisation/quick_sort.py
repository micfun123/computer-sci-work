...
def visualize_array(arr, pivot_index=None, low_index=None, high_index=None, step=None):
    ...
    if step is not None:
        ...
        draw.text((text_x, text_y), step_text, fill=fill_color, font=step_font, stroke_width=2, stroke_fill=outline_color)
...
frames[0].save("quick_sort_animation.gif", save_all=True, append_images=frames[1:], duration=frame_duration, loop=0)
print("Done!")
