...
def visualize_array(arr, step):
    ...
    step_font_size = max(
        12, int((width / 20))
    )  # Adjust the 10 based on your preferences
    step_font = ImageFont.truetype(
        "arial.ttf", step_font_size
    )  # You can specify a different font
...
frames[0].save(
    "Insertion_Sort_animation_colour.gif",
    save_all=True,
